...
public class GestorCompras {
	...
	public GestorCompras() throws IOException {
        ...
        for(Entry<Integer, HashMap<Integer, ArrayList<InfoComprasUIA>>> item : miProveedor.getProveedores().entrySet())
        {
            int iProveedor = item.getKey();
            HashMap<Integer, ArrayList<InfoComprasUIA>> nodo = item.getValue();
            mapper.writeValue(new File("C:/TSU-2022/ComprasProy/SolicitudOrdenCompra-Vendedor-"+iProveedor+".json"), nodo);
        }
